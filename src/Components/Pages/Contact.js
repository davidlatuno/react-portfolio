            ...
            <div>
                ...
                <div className="row">
                    <div className="col contactCol">
                        ...
                        <Card source={require("./images/resume.png")} text={<a href="https://github.com/davidlatuno/react-portfolio/blob/master/src/Components/Pages/images/David%20Latuno%20Resume.pdf" target="_blank"><button className="btn btn-dark">Resume</button></a>} />
