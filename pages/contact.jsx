  ...
  <div>
    ...
    <div className="row">
      <div className="col contactCol">
        ...
        <Card source="../static/pics/resume.png" text={<a href="https://github.com/davidlatuno/react-portfolio/blob/master/static/pics/David%20Latuno%20Resume.pdf" target="_blank" rel="noopener noreferrer"><button type="button" className="btn btn-dark">Resume</button></a>} />
